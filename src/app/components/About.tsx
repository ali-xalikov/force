...
export function About() {
  ...
  return (
    <div id="biz-haqimizda" className="relative py-24 bg-[#0B0F0A] overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            BIZ <span className="text-[#4CAF50]">HAQIMIZDA</span>
          </h2>
          <p
            className="text-lg text-white/70 max-w-3xl mx-auto leading-relaxed"
            style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 500 }}
          >
            UWED FORCE — yuqori tayyorgarlikka ega elita harbiy jamoa. 
            Biz murakkab vazifalarni tez va aniq bajarishga ixtisoslashganmiz. 
            Zamonaviy texnologiyalar va professional tajriba bilan jihozlanganmiz.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-[#1F2A1F]/40 backdrop-blur-md border border-[#4CAF50]/20 rounded-xl p-6 h-full transition-all duration-300 hover:border-[#4CAF50]/50 hover:shadow-lg hover:shadow-[#4CAF50]/20 overflow-hidden">
                  {/* Glow effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#4CAF50]/0 to-[#4CAF50]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  
                  {/* Icon */}
                  <div className="relative mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#4CAF50] to-[#2E7D32] rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-[#4CAF50]/30">
                      <Icon className="w-7 h-7 text-[#0B0F0A]" strokeWidth={2.5} />
                    </div>
                  </div>
                  ...
                  {/* Corner accent */}
                  <div className="absolute top-0 right-0 w-20 h-20 border-t-2 border-r-2 border-[#4CAF50]/30 rounded-tr-xl"></div>
                  <div className="absolute bottom-0 left-0 w-20 h-20 border-b-2 border-l-2 border-[#4CAF50]/30 rounded-bl-xl"></div>
                </div>
              </motion.div>
            );
          })}
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              className="text-center p-6 bg-[#1F2A1F]/30 backdrop-blur-sm border border-[#4CAF50]/20 rounded-lg hover:border-[#4CAF50]/50 transition-all duration-300"
            >
              <div
                className="text-4xl md:text-5xl font-black text-[#4CAF50] mb-2"
                style={{ fontFamily: 'Orbitron, sans-serif' }}
              >
                {stat.number}
              </div>
