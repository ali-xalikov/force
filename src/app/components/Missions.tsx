...
export function Missions() {
  const missions = [
    {
      ...
      date: "Mart 2026",
      description:
        "Maxfiy infiltratsiya va muhim ob'ektlarni himoya qilish operatsiyasi.",
      statusColor: "#830218",
      icon: CheckCircle,
    },
    {
      ...
      date: "Mart 2026",
      description:
        "Taktik yordam va razvedka ma'lumotlarini yig'ish bo'yicha faol operatsiya.",
      statusColor: "#830218",
      icon: Clock,
    },
    {
    ...
    },
    {
      ...
      date: "MAXFIY",
      description:
        "Missiya tafsilotlari eng yuqori darajadagi maxfiylik sinfiga kiradi.",
      statusColor: "#FF5252",
      icon: Lock,
    },
    {
    ...
    },
    {
      ...
      date: "Yanvar 2026",
      description:
        "Muhim infratuzilmalarni himoya qilish va mudofaa operatsiyalari.",
      statusColor: "#830218",
      icon: CheckCircle,
    },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Radar circles */}
      <div className="absolute top-10 right-10 w-96 h-96 border border-[#830218]/10 rounded-full"></div>
      <div className="absolute bottom-10 left-10 w-80 h-80 border border-[#830218]/10 rounded-full"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            TAKTIK <span className="text-[#830218]">MISSIYALAR</span>
          </h2>
          <p
            className="text-lg text-white/70 max-w-3xl mx-auto leading-relaxed"
            style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 500 }}
          >
            Joriy va o'tgan operatsiyalarimizning real vaqt ko'rinishi. Har bir
            missiya aniqlik, intizom va muvaffaqiyatga erishish majburiyati
            bilan bajariladi.
          </p>
        </motion.div>
        ...
        >
          {[
            { label: "Jami missiyalar", value: "500+", color: "#830218" },
            { label: "Faol operatsiyalar", value: "2", color: "#830218" },
            {
            ...
            <div
              key={stat.label}
              className="bg-[#1F2A1F]/40 backdrop-blur-md border border-[#830218]/20 rounded-xl p-6 hover:border-[#830218]/50 transition-all duration-300"
            >
              <div
              ...
              >
                ...
                <div className="relative bg-[#1F2A1F]/40 backdrop-blur-md border border-[#830218]/20 rounded-xl p-6 h-full transition-all duration-300 hover:border-[#830218]/50 hover:shadow-lg hover:shadow-[#830218]/20 overflow-hidden">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <div
                        className="text-[#830218]/70 text-xs font-bold tracking-wider mb-1"
                  ...
                  {/* Meta info */}
                  <div className="space-y-2 pt-4 border-t border-[#830218]/20">
                    <div className="flex items-center gap-2 text-white/60 text-sm">
                      <MapPin className="w-4 h-4 text-[#830218]" />
                      <span
                        style={{
                          fontFamily: "Rajdhani, sans-serif",
                          fontWeight: 500,
                    ...
                    <div className="flex items-center gap-2 text-white/60 text-sm">
                      <Calendar className="w-4 h-4 text-[#830218]" />
                      <span
                        style={{
                          fontFamily: "Rajdhani, sans-serif",
                          fontWeight: 500,
                  ...
                  {/* Corner accents */}
                  <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-[#830218]/30 rounded-br-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              </motion.div>
            );
          })}
