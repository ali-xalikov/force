      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-block mb-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-[#4CAF50]/10 border border-[#4CAF50]/30 rounded-full">
                ...
                <span className="text-[#4CAF50] text-sm tracking-[0.2em] font-bold">
                  UWED FORCE UNIT
                </span>
              </div>
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-white mb-4 uppercase italic">
              ELITA <span className="text-[#4CAF50]">SHAXSIY TARKIB</span>
            </h2>
          </motion.div>
          ...
          <div className="flex justify-center mb-20">
            ...
            >
              <div className="relative bg-[#1a2e1a]/40 backdrop-blur-xl border-2 border-yellow-500/30 rounded-2xl overflow-hidden p-1 shadow-2xl shadow-yellow-500/10">
                <div className="relative h-[450px] overflow-hidden rounded-xl">
                  ...
                  <div className="absolute top-4 right-4 w-14 h-14 bg-yellow-500 rounded-xl flex items-center justify-center shadow-lg shadow-yellow-500/40">
                    <leader.icon
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-center">
                    <span className="bg-yellow-500 text-black px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-3 inline-block">
                      {leader.role}
                    </span>
                    <h3 className="text-3xl font-black text-white tracking-tight leading-tight">
                      {leader.name}
                    </h3>
                    <p className="text-yellow-500/80 text-sm mt-2 font-medium">
                      {leader.specialty}
                    </p>
                  </div>
                </div>
              ...
              <div className="absolute -inset-4 bg-yellow-500/5 blur-3xl -z-10 group-hover:bg-yellow-500/10 transition-colors duration-500"></div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="absolute inset-0 bg-[#4CAF50]/10 blur-2xl opacity-0 group-hover:opacity-100 transition duration-500 rounded-3xl"></div>

                  <div className="relative bg-[#141d14] border border-white/10 rounded-3xl overflow-hidden backdrop-blur-xl hover:border-[#4CAF50]/40 transition-all duration-500 shadow-xl hover:shadow-green-500/20">
                    {/* Image */}
                    <div className="relative h-72 overflow-hidden">
                      ...
                      {/* Icon */}
                      <div className="absolute bottom-5 left-5 bg-[#4CAF50] p-3 rounded-2xl shadow-lg group-hover:rotate-6 group-hover:scale-110 transition-all duration-300">
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <span className="text-[#4CAF50] text-[11px] font-bold uppercase tracking-[0.25em]">
                        {member.role}
                      </span>

                      <h4 className="text-white font-extrabold text-xl mt-2 group-hover:text-[#4CAF50] transition-colors duration-300">
                        {member.name}
                      </h4>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                          <motion.div
                            ...
                            className="h-full rounded-full bg-gradient-to-r from-[#4CAF50] to-green-300"
                          />
                        </div>
                      </div>
                    </div>
